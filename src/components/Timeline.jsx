      ...
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            self-start max-w-xs md:flex-row top-40 lg:max-w-sm md:w-full">
              <div className="absolute flex items-center 
              justify-center w-10 h-10 rounded-full -left-[15px] bg-midnight">
                <div className="w-4 h-4 p-2 border 
                rounded-full bg-neutral-800 border-neutral-700" />
              </div>
        ...
        <div
          ...
          w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent 
